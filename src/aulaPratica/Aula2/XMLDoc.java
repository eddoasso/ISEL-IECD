...
final public class XMLDoc {
	...
	public static final NodeList getXPath(final String expression,
			final Document doc) {
	 ...
	 */
	public static final int getXPathN(final String expression,
			final Document doc) {
		XPath xpath = XPathFactory.newInstance().newXPath();
		try {
			return ((Double) xpath.evaluate(expression, doc,
	 ...
	 * 
	 */
	public static final String getXPathV(final String expression,
			final Document doc) {
	 ...
	 */
	public static final void StartSerialization(final Document DOMtree,
		...
		if ((DOMtree.getFeature("Core", "3.0") != null)
			...
			DOMiLS = (DOMImplementationLS) (DOMtree.getImplementation())
					.getFeature("LS", "3.0");
	...
	public static final void transfDoc(Document xml, String xsltFileName,
		...
		try {
			// Source input = new StreamSource(xmlFileName); com String
			// xmlFileName
	...
	public static final boolean validDocXSD(String xmlFileName,
			String vFileName) {
	...
	/**
	 * Valida��o de documento na �rvore DOM, com XSD ou DTD conforme o indicado
	 * no parametro type
	 * 
	 * @param document
	 * @param xsdFileName
	 ...
	 * @throws SAXException
	 */
	public static final boolean validDoc(Document document, String xsdFileName,
	...
	public static final String ListarFicheiros(String pasta) {
		...
		for (int i = 0; i < listOfFiles.length; i++)
			if (listOfFiles[i].isFile())
				result = result + "<ficheiro>" + listOfFiles[i].getName()
						+ "</ficheiro>\n";
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * String xmlFileName = contexto + "exemplo.xml"; String xsdFileName =
		 * contexto + "exemplo.xsd"; String dtdFileName = contexto +
		 * "exemplo.dtd";
		 * 
		 * String xsltHTMFileName = contexto + "exemplo.xsl";
		 * 
		 * String targetFileName = contexto + "save.xml"; String HTMFileName =
		 * contexto + "exemplo.htm";
		 */
